...
public class TestCharge {
    ...
    public static void main(String[] args) throws Exception {
        ...
        chargeRequestDTO
                ...
                .setCvv(EncryptionService.encrypt("{card_cvv_here}", encryptionKey, iv))
                .setCard_number(EncryptionService.encrypt("{card_number_here}", encryptionKey, iv))
                .setExpiry_month(EncryptionService.encrypt("{card_expiry_month}", encryptionKey, iv))
                .setExpiry_year(EncryptionService.encrypt("{card_expiry_year}", encryptionKey, iv));
